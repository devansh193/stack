...
export const NavItem = ({
  ...
  return (
    <AccordionItem value={organization.id} className="border-none space-y-1">
      <AccordionTrigger
        ...
        className={cn(
          ...
          isActive && !isExpanded && "bg-zinc-500/20 text-zinc-700"
        )}
      >
        ...
        {routes.map((route) => (
          <Button
            ...
            className={cn(
              ...
              pathname === route.href && "bg-zinc-500/10 text-zinc-700"
            )}
            variant="ghost"
          >
            {route.icon}
